...
/**
 * Print num of operations (shifts)
 ...
 */
public class InsertionSortNumShifts {


    private static int placeItemViaInsertionSort (int[] sortedNums, int index) {
    ...
    private static void insertionSortPart2(int[] sortedNums) {
        ...
        for (int i = 1; i < sortedNums.length; i++) {
            totalNumSwaps += placeItemViaInsertionSort(sortedNums, i);
            //printArray(sortedNums);
        }
        System.out.println(totalNumSwaps);
    }
